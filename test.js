...
TrilateralLines.__super__ = trilateralBasic_AppGL;
TrilateralLines.prototype = $extend(trilateralBasic_AppGL.prototype,{
	draw: function(pen) {
		var sketch = new trilateral3_drawing_Sketch(pen,2,0);
		sketch.width = 1.7;
...
function TrilateralLines_main() {
	...
	haxe_Log.trace("TrilateralLines example",{ fileName : "TrilateralLines.hx", lineNumber : 25, className : "_TrilateralLines.TrilateralLines_Statics_", methodName : "main"});
}
